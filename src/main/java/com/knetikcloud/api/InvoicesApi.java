...
public class InvoicesApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public TemplateResource createInvoiceTemplate(TemplateResource invoiceTemplateResource) throws ApiException {
    Object localVarPostBody = invoiceTemplateResource;
    
    // create path and map variables
    String localVarPath = "/invoices/templates";
   ...
   * @throws ApiException if fails to make API call
   */
  public void deleteInvoiceTemplate(String id, String cascade) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling deleteInvoiceTemplate");
    }
    
    // create path and map variables
    String localVarPath = "/invoices/templates/{id}"
   ...
   * @throws ApiException if fails to make API call
   */
  public TemplateResource getInvoiceTemplate(String id) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling getInvoiceTemplate");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceTemplateResource getInvoiceTemplates(Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
   ...
   * @throws ApiException if fails to make API call
   */
  public void setAdditionalProperties(Integer id, Object properties) throws ApiException {
    Object localVarPostBody = properties;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling setAdditionalProperties");
    }
    
    // verify the required parameter 'properties' is set
    if (properties == null) {
      throw new ApiException(400, "Missing the required parameter 'properties' when calling setAdditionalProperties");
    }
    
    // create path and map variables
    String localVarPath = "/invoices/{id}/properties"
      .replaceAll("\\{" + "id" + "\\}", apiClient.escapeString(id.toString()));
   ...
   * @throws ApiException if fails to make API call
   */
  public TemplateResource updateInvoiceTemplate(String id, PatchResource templatePatchResource, Boolean testValidation) throws ApiException {
    Object localVarPostBody = templatePatchResource;
    
    // verify the required parameter 'id' is set
    if (id == null) {
      throw new ApiException(400, "Missing the required parameter 'id' when calling updateInvoiceTemplate");
    }
