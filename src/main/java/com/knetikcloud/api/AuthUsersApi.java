...
public class AuthUsersApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public PageResourceUserSidResource getSids(Integer userId, Integer size, Integer page, String order) throws ApiException {
    Object localVarPostBody = null;
    
    // verify the required parameter 'userId' is set
    if (userId == null) {
      throw new ApiException(400, "Missing the required parameter 'userId' when calling getSids");
    }
