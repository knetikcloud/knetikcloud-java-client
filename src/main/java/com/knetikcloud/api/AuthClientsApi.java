...
public class AuthClientsApi {
   ...
   * @return PageResourceGrantTypeResource
   * @throws ApiException if fails to make API call
   */
  public PageResourceGrantTypeResource getClientGrantTypes(Integer size, Integer page) throws ApiException {
    Object localVarPostBody = null;
    ...
    GenericType<PageResourceGrantTypeResource> localVarReturnType = new GenericType<PageResourceGrantTypeResource>() {};
    return apiClient.invokeAPI(localVarPath, "GET", localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localVarReturnType);
      }
  /**
