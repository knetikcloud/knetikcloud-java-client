...
public class StoreSubscriptionsApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public SubscriptionTemplateResource updateSubscriptionTemplate(String id, PatchResource templatePatchResource, Boolean testValidation) throws ApiException {
