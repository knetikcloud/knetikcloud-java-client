...
```groovy
compile "com.knetikcloud:knetikcloud-java-client:3.0.274"
```
...
* target/knetikcloud-java-client-3.0.274.jar
* target/lib/*.jar
...
*UsersGroupsApi* | [**createGroupMemberTemplate**](docs/UsersGroupsApi.md#createGroupMemberTemplate) | **POST** /users/groups/members/templates | Create a group member template
...
*UsersGroupsApi* | [**updateGroupMemberOrder**](docs/UsersGroupsApi.md#updateGroupMemberOrder) | **PUT** /users/groups/{unique_name}/members/{user_id}/order | Change a user&#39;s order
*UsersGroupsApi* | [**updateGroupMemberProperties**](docs/UsersGroupsApi.md#updateGroupMemberProperties) | **PUT** /users/groups/{unique_name}/members/{user_id}/properties | Change a user&#39;s membership properties
...
*UsersGroupsApi* | [**updateGroupMemberTemplate**](docs/UsersGroupsApi.md#updateGroupMemberTemplate) | **PATCH** /users/groups/members/templates/{id} | Update a group member template
*UsersGroupsApi* | [**updateGroupTemplate**](docs/UsersGroupsApi.md#updateGroupTemplate) | **PATCH** /users/groups/templates/{id} | Update a group template
...
*UsersInventoryApi* | [**getInventoryList**](docs/UsersInventoryApi.md#getInventoryList) | **GET** /inventories | List the user inventory entries for all users
...
*UsersInventoryApi* | [**updateEntitlementTemplate**](docs/UsersInventoryApi.md#updateEntitlementTemplate) | **PATCH** /entitlements/templates/{id} | Update an entitlement template
...
*UsersRelationshipsApi* | [**getRelationship**](docs/UsersRelationshipsApi.md#getRelationship) | **GET** /users/relationships/{id} | Get a user relationship
...
*VerificationApi* | [**createRequestTemplate**](docs/VerificationApi.md#createRequestTemplate) | **POST** /verification/templates | Create a request template
*VerificationApi* | [**createVerificationRequest**](docs/VerificationApi.md#createVerificationRequest) | **POST** /verification/requests | Create a new request
*VerificationApi* | [**deleteRequestTemplate**](docs/VerificationApi.md#deleteRequestTemplate) | **DELETE** /verification/templates/{id} | Delete a request template
*VerificationApi* | [**deleteVerificationRequest**](docs/VerificationApi.md#deleteVerificationRequest) | **DELETE** /verification/requests/{code} | Delete an existing request
*VerificationApi* | [**getRequestTemplate**](docs/VerificationApi.md#getRequestTemplate) | **GET** /verification/templates/{id} | Get a single request template
*VerificationApi* | [**getRequestTemplates**](docs/VerificationApi.md#getRequestTemplates) | **GET** /verification/templates | List and search request templates
*VerificationApi* | [**getVerificationRequest**](docs/VerificationApi.md#getVerificationRequest) | **GET** /verification/requests/{code} | Get a single verification request
*VerificationApi* | [**getVerificationRequests**](docs/VerificationApi.md#getVerificationRequests) | **GET** /verification/requests | List requests
*VerificationApi* | [**updateRequestTemplate**](docs/VerificationApi.md#updateRequestTemplate) | **PATCH** /verification/templates/{id} | Update a request template
*VerificationApi* | [**updateVerificationRequest**](docs/VerificationApi.md#updateVerificationRequest) | **PUT** /verification/requests/{code} | Update an existing request
*VerificationApi* | [**verifyRequest**](docs/VerificationApi.md#verifyRequest) | **POST** /verification/requests/{code}/responses | Verify a request
...
## Documentation for Models
 ...
 - [AccessResultsResource](docs/AccessResultsResource.md)
 ...
 - [ClientCustomizationResource](docs/ClientCustomizationResource.md)
 ...
 - [LongWrapper](docs/LongWrapper.md)
 ...
 - [MonitoringAlertLevel](docs/MonitoringAlertLevel.md)
 - [MonitoringAlertResource](docs/MonitoringAlertResource.md)
 - [MonitoringIncidentEventResource](docs/MonitoringIncidentEventResource.md)
 ...
 - [OAuth2ProviderResource](docs/OAuth2ProviderResource.md)
 ...
 - [PageResourceAccessResultsResource](docs/PageResourceAccessResultsResource.md)
 ...
 - [PageResourceActionResource](docs/PageResourceActionResource.md)
 ...
 - [PageResourceAnswerResource](docs/PageResourceAnswerResource.md)
 ...
 - [PageResourceBehaviorDefinitionResource](docs/PageResourceBehaviorDefinitionResource.md)
 ...
 - [PageResourceChatBlacklistResource](docs/PageResourceChatBlacklistResource.md)
 ...
 - [PageResourceCountryResource](docs/PageResourceCountryResource.md)
 ...
 - [PageResourceDeltaResource](docs/PageResourceDeltaResource.md)
 - [PageResourceDeviceResource](docs/PageResourceDeviceResource.md)
 - [PageResourceDispositionCount](docs/PageResourceDispositionCount.md)
 ...
 - [PageResourceExpressionResource](docs/PageResourceExpressionResource.md)
 ...
 - [PageResourceGrantTypeResource](docs/PageResourceGrantTypeResource.md)
 ...
 - [PageResourceInventorySubscriptionResource](docs/PageResourceInventorySubscriptionResource.md)
 ...
 - [PageResourceMonitoringAlertResource](docs/PageResourceMonitoringAlertResource.md)
 - [PageResourceMonitoringIncidentEventResource](docs/PageResourceMonitoringIncidentEventResource.md)
 - [PageResourceMonitoringIncidentResource](docs/PageResourceMonitoringIncidentResource.md)
 - [PageResourceMonitoringMetricResource](docs/PageResourceMonitoringMetricResource.md)
 ...
 - [PageResourceOAuth2ProviderResource](docs/PageResourceOAuth2ProviderResource.md)
 ...
 - [PageResourcePaymentMethodResource](docs/PageResourcePaymentMethodResource.md)
 ...
 - [PageResourcePropertyFieldListResource](docs/PageResourcePropertyFieldListResource.md)
 ...
 - [PageResourceSearchDocument](docs/PageResourceSearchDocument.md)
 ...
 - [PageResourceStateResource](docs/PageResourceStateResource.md)
 ...
 - [PageResourceVariableTypeResource](docs/PageResourceVariableTypeResource.md)
 - [PageResourceVendorResource](docs/PageResourceVendorResource.md)
 - [PageResourceVerificationRequest](docs/PageResourceVerificationRequest.md)
